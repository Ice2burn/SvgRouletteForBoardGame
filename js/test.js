...
var pieText= [
  'Выпей х1',
  'Опустоши стакан или Пропусти ход',
  'Выпей x5',
  'Выпей х2',
  'ДЖЕКПОТ! Опустоши стакан',
  'Укажи на двоих, кто пьет х2',
  'Укажи на двоих, кто пьет х3',
  'Выпей и кидай кубик снова!',
  'Получи чёрную метку до следующего хода',
  'Выпей х3',
  'Выпей х2 и Крути вновь',
  'Ничего'
];
